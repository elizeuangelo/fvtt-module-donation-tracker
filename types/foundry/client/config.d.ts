...
declare global {
	interface Config<
		...
		TTileDocument extends TileDocument<TScene | null> = TileDocument<TScene | null>,
		TTokenDocument extends TokenDocument<TScene | null> = TokenDocument<TScene | null>,
		TWallDocument extends WallDocument<TScene | null> = WallDocument<TScene | null>,
		TUser extends User<Actor<null>> = User<Actor<null>>,
		TEffectsCanvasGroup extends EffectsCanvasGroup = EffectsCanvasGroup,
		TAmbientLightDocument extends AmbientLightDocument<TScene | null> = AmbientLightDocument<TScene | null>,
		TActor extends Actor<TTokenDocument | null> = Actor<TTokenDocument | null>,
		TItem extends Item<TActor | null> = Item<TActor | null>,
		TActiveEffect extends ActiveEffect<TActor | TItem | null> = ActiveEffect<TActor | TItem | null>,
		TActorDelta extends ActorDelta<TTokenDocument | null> = ActorDelta<TTokenDocument | null>,
		TChatLog extends ChatLog = ChatLog,
		TChatMessage extends ChatMessage = ChatMessage,
		TCombat extends Combat = Combat,
		TCombatant extends Combatant<TCombat | null, TTokenDocument | null> = Combatant<TCombat | null, TTokenDocument | null>,
		...
		TMeasuredTemplateDocument extends MeasuredTemplateDocument<TScene | null> = MeasuredTemplateDocument<TScene | null>
	> {
		...
		Actor: {
			...
			dataModels: Record<string, AbstractConstructorOf<foundry.abstract.DataModel>>;
		};
