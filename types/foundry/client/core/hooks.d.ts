...
declare global {
	...
	class Hooks {
		...
		static on<T extends keyof SystemHooks>(...args: HookParameters<T, SystemHooks[T]>): number;
		...
		static once<T extends keyof SystemHooks>(...args: HookParameters<T, SystemHooks[T]>): number;
		 ...
		 */
		static callAll<T extends keyof SystemHooks>(hook: T, ...args: SystemHooks[T]): boolean;
		 ...
		 * @param args  Arguments passed to the hook callback functions
		 */
		static call<T extends keyof SystemHooks>(hook: T, ...args: SystemHooks[T]): boolean;
