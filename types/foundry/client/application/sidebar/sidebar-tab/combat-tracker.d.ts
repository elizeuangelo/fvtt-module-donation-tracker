...
> extends SidebarTab<TOptions> {
	 ...
	 */
	_onToggleDefeatedStatus(combatant: Combatant<TCombat>): Promise<void>;
	 ...
	 */
	hoverCombatant(combatant: Combatant<TCombat>, hover: boolean): void;

	/**
	 * Handle pinging a combatant Token
	 * @param {Combatant} combatant     The combatant data
	 * @returns {Promise}               A Promise which resolves once the ping animation has completed
	 */
	_onPingCombatant(combatant: Combatant<TCombat>): Promise<void>;
	 ...
	 */
	_onCombatantMouseDown(event: MouseEvent): Promise<void>;

	/** Handle mouse-hover events on a combatant in the tracker */
	_onCombatantHoverIn(event: MouseEvent): Promise<void>;

	/**
	 * Handle mouse-unhover events for a combatant in the tracker
	 */
	_onCombatantHoverOut(event: MouseEvent): void;
