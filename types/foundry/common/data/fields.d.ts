...
> implements DataFieldOptions<TSourceProp, TRequired, TNullable, THasInitial>
{
	 ...
	 */
	_getField(path: string[]): this | DataField | undefined;
}
...
declare class DataModelValidationError extends Error {
	 ...
	 */
	getAllFailures(): { [prop: string]: DataModelValidationFailure };
	 ...
	 * @returns {DataModelValidationFailure|Object<DataModelValidationFailure>}  Returns the failure at the leaf of the tree, otherwise an object of sub-failures.
	 */
	static #aggregateFailures(
		failure: DataModelValidationFailure
	): DataModelValidationFailure | { [prop: string]: DataModelValidationFailure };
}
