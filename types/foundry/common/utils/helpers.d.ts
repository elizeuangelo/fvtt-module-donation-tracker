 ...
 */
export function getDocumentClass<T extends foundry.abstract.Document & { get sheet(): FormApplication<T> } = any>(
	documentName: string
): ConstructorOf<T>;
...
declare global {
	...
	namespace globalThis {
		...
		var getDocumentClass: typeof foundry.utils.getDocumentClass;
