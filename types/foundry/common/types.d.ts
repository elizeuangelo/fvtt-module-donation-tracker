...
declare global {
	...
	interface DocumentModificationContext<TParent extends Document | null> {
		...
		deleteAll?: boolean;
		/** Whether to delete all subfolders of a folder when it is deleted. Only used during a delete operation. */
		deleteSubfolders?: boolean;
		/** Whether to delete all contents of a folder when it is deleted. Only used during a delete operation. */
